...
## Road Network Analysis for Panel 

```{r setup, include=FALSE}

# Read the GeoJSON file
booking_data <- st_read("./Booking Data_cleaned.geojson")

completestreets <- st_read("./CompleteStreets.geojson")

bike_network <- st_read("./Bike_Network.geojson")

simple_panel <- read_csv("./03_31_panel.csv")
