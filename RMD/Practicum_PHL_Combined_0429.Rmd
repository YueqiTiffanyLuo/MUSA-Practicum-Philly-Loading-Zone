...
tm8 <- tm_shape(Pred_1_3_by_curb) +
  tm_lines(col = "Prediction_Sum", alpha = 0.5, legend.show=FALSE, id="curb_id", lwd=4) +
  tm_layout(title = "Prediction by Curbs from January to March, 2025")
...
```{r eval=FALSE, include=FALSE}
all_geometry<-read_csv("./allcurbs_geometry_0505.csv")
```
