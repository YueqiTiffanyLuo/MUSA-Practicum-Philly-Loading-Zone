...
```{r timeandviolation,echo=TRUE, fig.height=4, fig.width=8}
...
```{r nearest neighbors, fig.height=6, fig.width=12, message=FALSE}
...
```{r roc, echo=TRUE, fig.height=4, fig.width=4}
# ROC curve
...
```{r pred_all_1_3, echo=TRUE, fig.height=4, fig.width=8}
