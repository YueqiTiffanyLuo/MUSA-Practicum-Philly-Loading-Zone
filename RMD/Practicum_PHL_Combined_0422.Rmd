...
#Bookings
curbs <- st_read("./all_curbs_0415.geojson")
...
sf_amenities <- st_read("./amenities.geojson")
...
sf_buildings <- st_read("./buildings.geojson")
...
sf_landuse <- st_read("./landuse.geojson")
...
sf_shops <- st_read("./shops.geojson")
...
sf_offices <- st_read("./offices.geojson")
...
#Bookings
bookings <- st_read("./Booking Data_cleaned.geojson") %>%
  st_transform(2272)
all_curbs <- st_read("./curbs_road_type/all_curbs_road_type.shp") %>%
...
road_classes <- st_read("./curbs_road_type/simple_road_classes.shp") %>%
...
write.csv(panel_data, "C:/Users/YLuo/OneDrive - ARCADIS/Desktop/3.29EDA_Tiffany/updated_04_01_panel.csv", row.names = FALSE)
...
old_panel <- read.csv("./updated_04_01_panel.csv")
panel <- read_sf("./morning_only_panel.geojson")
